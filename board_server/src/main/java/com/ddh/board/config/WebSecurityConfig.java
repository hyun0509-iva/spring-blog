...
import com.ddh.board.filter.JwtAuthenticationFilter;
...
public class WebSecurityConfig {
  ...
  protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
    // spring security v6에서는 아래 코드를 변경해야함
    httpSecurity
        .cors(cors -> cors
        ...
        .authorizeHttpRequests(request -> request
            .requestMatchers("/", "/api/v1/auth/**", "/api/v1/seach/**", "/file/**").permitAll()
